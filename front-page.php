        ...
        <div class="dplay-tbl">
            <div class="dplay-tbl-cell center-text color-white">
                ...
                <h5>
                    ...
                    <a href="<?php echo $hero['link'];?>" class="btn-primaryc plr-25"><b>
                    
                    <?php echo $hero['link_text']?></b></a>
                </h5>
                <?php endif; ?>
            </div><!-- dplay-tbl-cell -->
        </div><!-- dplay-tbl -->
...
<?php if( have_rows('our_menu') ): ?>
    ...
    <?php while( have_rows('our_menu') ): the_row();
     ...
     ?>
        <li><a class="active" href="#" data-select="<?php echo sanitize_title($category_name); ?>"><b><?php echo $category_name;?></b></a></li>
...
<?php if( have_rows('category') ): ?>
    ...
    ?>
            <div class="sided-90x mb-30 ">
                <div class="s-left"><img class="br-3" src="<?php echo $image['sizes']['product_image_size_small'];?>" alt="Menu Image"></div><!--s-left-->
                    <div class="s-right">
